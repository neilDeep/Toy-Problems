...
LinkedList.prototype.removeThisNode = function(position) {
  // Prompt: Given a position (aka index),
    // remove the node within given position in this LinkedList
  ...
  var removedValue = currentNode.value;
  delete currentNode;
  return removedValue;
};
